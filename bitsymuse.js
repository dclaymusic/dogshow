...
var hackOptions = {
	...
	audio: {
		...
		'bg': { src: 'bg.mp3', loop: true },
		'end': { src: 'end.mp3', loop: false },
		'adeline': { src: 'adeline.mp3', loop: true },
		'akbar': { src: 'akbar.mp3', loop: true },
		'alyse': { src: 'alyse.mp3', loop: true },
		'ammar': { src: 'ammar.mp3', loop: true },
		'anton': { src: 'anton.mp3', loop: true },
		'ari': { src: 'ari.mp3', loop: true },
		'asha': { src: 'asha.mp3', loop: true },
		'cohen': { src: 'cohen.mp3', loop: true },
		'colette': { src: 'colette.mp3', loop: true },
		'hailey': { src: 'hailey.mp3', loop: true },
		'izzy': { src: 'izzy.mp3', loop: true },
		'james': { src: 'james.mp3', loop: true },
		'kabir': { src: 'kabir.mp3', loop: true },
		'kaia': { src: 'kaia.mp3', loop: true },
		'lucy': { src: 'lucy.mp3', loop: true },
		'magda': { src: 'magda.mp3', loop: true },
		'margaux': { src: 'margaux.mp3', loop: true },
		'max': { src: 'max.mp3', loop: true },
		'milo': { src: 'milo.mp3', loop: true },
		'nari': { src: 'nari.mp3', loop: true },
		'neil': { src: 'neil.mp3', loop: true },
		'nico': { src: 'nico.mp3', loop: true },
		'niko': { src: 'niko.mp3', loop: true },
		'patchy': { src: 'patchy.mp3', loop: true },
		'rayan': { src: 'rayan.mp3', loop: true },
		'rohan': { src: 'rohan.mp3', loop: true },
		'reece': { src: 'reece-august.mp3', loop: true },
